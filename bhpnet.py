#Some administrators will remove netcat from system. Implementing this script can allow for a Python callback
#as secondary access before attempting to insert a trojan or other backdoor
